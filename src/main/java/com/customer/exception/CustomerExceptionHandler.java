...
public class CustomerExceptionHandler {
  ...
  public ResponseEntity<FailureResponse> handleValidationException(
      RuntimeException ex, WebRequest webRequest) {
    FailureResponse failureResponse = new FailureResponse();
    failureResponse.setErrorType(ex.getClass().getName());
    failureResponse.setMessage(ex.getMessage());
  ...
  public ResponseEntity<FailureResponse> handleAuthException(
  ...
  public ResponseEntity<FailureResponse> handleBindingException(
